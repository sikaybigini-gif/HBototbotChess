...
# 50. ve 100. kapı karşılaşmalarını görmek için:
./nightshift-server --port 8080 --doors 100
```

Sunucu haritası 12–100 kapı arasında olabilir; 50 ve 100 numaralı kapılar haritaya dahilse Kör Nöbetçi karşılaşması garanti edilir.
...
- Rota şeridinde 50 ve 100. kapı karşılaşmaları önceden kırmızı milestone işaretiyle görünür; karşılaşma sırasında ana kontrol sessizce saklanmaya odaklanır
...
- **50 ve 100 numaralı kapılarda Kör Nöbetçi** karşılaşması: görmez, fakat ses çıkaran oyuncuyu izler; ekip sessizce dolaplara saklanarak geçer
- `kaydet` / `yükle` desteği

### Kör Nöbetçi karşılaşması

50. kapı ve haritada varsa 100. kapı, normal rastgele tehditlerden farklı özel salonlardır. Bu özgün yaratık görsel ipuçlarını kullanamaz; ses, acele ve kapı kolu gibi hareketleri algılar. Web veya terminal sürümünde karşılaşma başladığında ekip saklanmalı, tehdit banner'ı kaybolduktan sonra dolaptan çıkıp ilerlemelidir. Saklanmadan kapıyı açmaya çalışmak engellenir; uzun süre gürültü yapmak ciddi hasar verir. Çantadaki jeton, `kullan jeton` ile uzağa yuvarlanarak ses izini sıfırlar ve ekibe bir hamle kazandırır. 100 kapılı haritada normal kovalamacalar 50. kapıyla çakışmaması için daha erken bir koridora kaydırılır.
